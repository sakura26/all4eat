          ...
          <div class="col-md-9">
            ...
            <div id="members">
              ...
              <spam>
                ...
                <?php if (!isset($user)){ ?>
                <input type="text" id="email" name="email" placeholder="email必填" class="form-control" style="width: 250px;"><br>
                <input type="text" id="nickname" name="nickname" placeholder="暱稱" class="form-control" style="width: 250px;"><br>
                <input type="text" id="cellphone" name="cellphone" placeholder="手機" class="form-control" style="width: 250px;"><br>
                <?php } ?>
